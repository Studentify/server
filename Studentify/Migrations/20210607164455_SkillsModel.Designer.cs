...
namespace Studentify.Migrations
{
    ...
    [Migration("20210607164455_SkillsModel")]
    partial class SkillsModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Studentify.Models.Skill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Studentify.Models.Skill", b =>
                {
                    b.HasOne("Studentify.Models.StudentifyAccount", "Owner")
                        .WithMany("Skills")
            ...
            modelBuilder.Entity("Studentify.Models.StudentifyEvents.TradeOffer", b =>
                {
                    b.HasOne("Studentify.Models.StudentifyAccount", "Buyer")
                        .WithMany()
